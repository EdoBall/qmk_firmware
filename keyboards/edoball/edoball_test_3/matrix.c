...
Column Address Pins Enable: GP3
Column Address Pins for 74HC4067: {GP4, GP5, GP6, GP7};
Column Signal Pin: GP8
Row pins:  {GP9, GP10, GP11, GP12, GP13};
touch key pins: GP26 - GP29
LED: 
*/
...
#define CAPINE GP3
// Column Address Pins
#define CAPINS {GP4, GP5, GP6, GP7}
// Column Signal Pin
#define CSPIN GP8
// Row pins are defined by info.json (not here)
// #define RPINS {GP9, GP10, GP11, GP12};
...
// static uint8_t addrPins[4] = {GP4, GP5, GP6, GP7};
...
uint8_t readMatrixCol(uint8_t col_index) {
    ...
    setPinOutput_writeLow(CAPINE); // unselect the 74HC4067
    ...
    wait_us(1);
    setPinOutput_writeHigh(CAPINE); // select the 74HC4067
    wait_us(1);
