...
const key_override_t *us_key_on_jp_os_overrides[] =
    {
     ...
     &ko_make_basic(0, KC_BSLS, JP_YEN),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_LCTL, CC_USJP, KC_LGUI, KC_LALT, KC_SPC, KC_ENT,   KC_INT4, KC_SPC,  KC_BSPC, KC_RALT, KC_DEL,  KC_INT5, CC_ADJUST,KC_NO,KC_NO, KC_NO \
                                  ),
   ...
   KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  CC_PR1,CC_PCB1,CC_TW1, \
   KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO, \
   KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_SCLN, KC_QUOT, KC_ENT,  KC_NO, KC_NO, KC_NO, \
   KC_LSFT, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0),S(KC_MINS),S(KC_EQL),KC_NO,KC_NO,KC_NO, \
   KC_LCTL, KC_CAPS, KC_LGUI, KC_LALT, KC_SPC, KC_ENT,   KC_INT4, KC_SPC,  KC_BSPC, KC_RALT, KC_DEL,  KC_CAPS, KC_BSPC, KC_NO, KC_NO, KC_NO \
                                                                        ), \
    [_TENKEY] = LAYOUT_ortho_16x5(                                       \
   QK_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NUM,    KC_PSLS,KC_PAST,   KC_PMNS, KC_0,    KC_MINS, KC_EQL,  CC_PR1,CC_PCB1,CC_TW1, \
   ...
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1,   KC_P2,   KC_P3,    KC_PENT ,KC_SLSH, KC_RSFT, KC_BSLS, KC_NO, KC_NO, KC_NO, \
   KC_LCTL, KC_CAPS, KC_LGUI, KC_LALT, KC_SPC, KC_ENT,   KC_P0,   KC_P0,   KC_PDOT,  KC_PENT, KC_DEL,  KC_CAPS, KC_BSPC, KC_NO, KC_NO, KC_NO \
                                                                        ), \
   ...
   CC_INFO, CC_USUS, CC_USJP, CC_CTL_INV,CC_TBUP,CC_TBDWN,KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  CC_PR1,CC_PCB1,CC_TW1, \
   KC_TAB,  CC_EMACS,CC_VI,   CC_WASD, CC_TENKEY, KC_T,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO, \
   KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_NO, KC_NO, KC_NO, \
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_BSLS, KC_NO, KC_NO, KC_NO, \
   KC_LCTL, KC_CAPS, KC_LGUI, KC_LALT, KC_SPC, KC_ENT,   KC_INT4, KC_SPC,  KC_BSPC, KC_RALT, KC_DEL,  KC_CAPS, CC_ADJUST,KC_NO, KC_NO, KC_NO \
                                                                        ), \
};
...
void keyboard_post_init_user(void) {
  ...
  rgblight_mode((uint8_t)(RGBLIGHT_MODE_RAINBOW_MOOD) + 1);
